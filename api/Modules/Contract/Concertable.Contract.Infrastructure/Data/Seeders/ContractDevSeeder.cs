...
internal class ContractDevSeeder : IDevSeeder
{
    ...
    public ContractDevSeeder(ContractDbContext context)
    {
    ...
    public async Task SeedAsync(CancellationToken ct = default)
    {
        await context.Contracts.SeedIfEmptyAsync(async () =>
        {
            var contracts = new ContractEntity[]
            {
                ...
                FlatFeeContractEntity.Create(200m, PaymentMethod.Cash),         // 6  — opp[5] ConfirmedApp
                ...
                VenueHireContractEntity.Create(300m, PaymentMethod.Cash),       // 21 — opp[20] PostedVenueHire
                ...
                FlatFeeContractEntity.Create(200m, PaymentMethod.Cash),         // 31 — opp[30] PostedFlatFee
                FlatFeeContractEntity.Create(140m, PaymentMethod.Cash),         // 32 — opp[31]
                FlatFeeContractEntity.Create(150m, PaymentMethod.Cash),         // 33 — opp[32] AwaitingPayment
                ...
                DoorSplitContractEntity.Create(70m, PaymentMethod.Cash),        // 50 — opp[49] FinishedDoorSplit (E2E expects 70%)
                VersusContractEntity.Create(100m, 70m, PaymentMethod.Cash),     // 51 — opp[50] FinishedVersus  (E2E expects £100 + 70%)
                FlatFeeContractEntity.Create(170m, PaymentMethod.Cash),         // 52 — opp[51]
                DoorSplitContractEntity.Create(65m, PaymentMethod.Cash),        // 53 — opp[52] PostedDoorSplit
                VersusContractEntity.Create(120m, 60m, PaymentMethod.Cash),     // 54 — opp[53] PostedVersus
                ...
                FlatFeeContractEntity.Create(150m, PaymentMethod.Cash),         // 58 — opp[57] UpcomingFlatFee
                VenueHireContractEntity.Create(300m, PaymentMethod.Cash),       // 59 — opp[58] UpcomingVenueHire
            };
