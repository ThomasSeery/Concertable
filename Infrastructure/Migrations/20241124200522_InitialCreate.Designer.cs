...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241124200522_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Identity.HotelManager", b =>
                {
                    b.HasBaseType("Core.Entities.Identity.ApplicationUser");

                    b.HasDiscriminator().HasValue("HotelManager");
                });

            modelBuilder.Entity("Core.Entities.Identity.TaxiManager", b =>
                {
                    b.HasBaseType("Core.Entities.Identity.ApplicationUser");

                    b.HasDiscriminator().HasValue("TaxiManager");
                });
            ...
            modelBuilder.Entity("Concertible.Entities.Hotel", b =>
                {
                    b.HasOne("Core.Entities.Identity.HotelManager", null)
                        .WithMany("Hotels")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Concertible.Entities.TaxiCompany", b =>
                {
                    b.HasOne("Core.Entities.Identity.TaxiManager", null)
