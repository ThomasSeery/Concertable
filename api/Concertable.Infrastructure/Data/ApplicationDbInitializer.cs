    ...
    public async Task InitializeAsync()
    {
        ...
        if (!context.Tickets.Any())
        {
            ...
            if (!context.Reviews.Any())
            {
                ...
                {
                new ReviewEntity { TicketId = tickets[0].Id, Stars = 4, Details = "Amazing performance!" },
                new ReviewEntity { TicketId = tickets[1].Id, Stars = 5, Details = "Loved every moment!" },
                new ReviewEntity { TicketId = tickets[2].Id, Stars = 5, Details = "Unforgettable night!" },
                new ReviewEntity { TicketId = tickets[3].Id, Stars = 4, Details = "Great energy from the crowd." },
                new ReviewEntity { TicketId = tickets[4].Id, Stars = 3, Details = "Good, but the sound was a bit off." },
                new ReviewEntity { TicketId = tickets[5].Id, Stars = 5, Details = "Perfect setlist and vibes!" },
                new ReviewEntity { TicketId = tickets[6].Id, Stars = 4, Details = "Would attend again!" },

                new ReviewEntity { TicketId = tickets[7].Id, Stars = 5, Details = "Fantastic indie atmosphere." },
                new ReviewEntity { TicketId = tickets[8].Id, Stars = 4, Details = "Loved the venue!" },
                new ReviewEntity { TicketId = tickets[9].Id, Stars = 4, Details = "Solid performance." },
                new ReviewEntity { TicketId = tickets[10].Id, Stars = 5, Details = "Caught my new favorite artist!" },
                new ReviewEntity { TicketId = tickets[11].Id, Stars = 3, Details = "Good music, but crowded." },
                new ReviewEntity { TicketId = tickets[12].Id, Stars = 5, Details = "Indie dream come true." },
                new ReviewEntity { TicketId = tickets[13].Id, Stars = 4, Details = "Chill night out." },

                new ReviewEntity { TicketId = tickets[14].Id, Stars = 5, Details = "Incredible stage presence!" },
                new ReviewEntity { TicketId = tickets[15].Id, Stars = 4, Details = "Would love to see them again." },
                new ReviewEntity { TicketId = tickets[16].Id, Stars = 5, Details = "Next-level visuals." },
                new ReviewEntity { TicketId = tickets[17].Id, Stars = 4, Details = "Very unique sound." },
                new ReviewEntity { TicketId = tickets[18].Id, Stars = 4, Details = "Great crowd energy." },
                new ReviewEntity { TicketId = tickets[19].Id, Stars = 5, Details = "Absolute fire show." },
                new ReviewEntity { TicketId = tickets[20].Id, Stars = 5, Details = "Perfect DnB experience." },

                new ReviewEntity { TicketId = tickets[21].Id, Stars = 4, Details = "Smooth lyrical vibes." },
                new ReviewEntity { TicketId = tickets[22].Id, Stars = 5, Details = "Top-tier show!" },
                new ReviewEntity { TicketId = tickets[23].Id, Stars = 4, Details = "Nice intimate gig." },
                new ReviewEntity { TicketId = tickets[24].Id, Stars = 3, Details = "A bit too loud but still fun." },
                new ReviewEntity { TicketId = tickets[25].Id, Stars = 4, Details = "Well organized event." },
                new ReviewEntity { TicketId = tickets[26].Id, Stars = 5, Details = "Really enjoyed it." },
                new ReviewEntity { TicketId = tickets[27].Id, Stars = 5, Details = "Brought my friends, all loved it." },

                new ReviewEntity { TicketId = tickets[28].Id, Stars = 3, Details = "Solid but expected more." },
                new ReviewEntity { TicketId = tickets[29].Id, Stars = 4, Details = "The lighting was amazing!" },
                new ReviewEntity { TicketId = tickets[30].Id, Stars = 5, Details = "Instant classic." },
                new ReviewEntity { TicketId = tickets[31].Id, Stars = 4, Details = "Had a great time." },
                new ReviewEntity { TicketId = tickets[32].Id, Stars = 4, Details = "Venue was packed with energy." }
                };
