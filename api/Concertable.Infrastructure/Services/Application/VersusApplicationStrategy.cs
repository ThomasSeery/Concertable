...
public class VersusApplicationStrategy : IApplicationStrategy
{
    ...
    public VersusApplicationStrategy(
    ...
    public async Task CompleteAsync(int concertId)
    {
        ...
        throw new NotImplementedException("Versus payout not yet implemented");
    }
}
