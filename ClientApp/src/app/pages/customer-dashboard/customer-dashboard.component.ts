  ...
  eventHeaders: EventHeader[] = [
    {
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Sunset',
      county: 'Palm County',
      town: 'Beachville',
      latitude: 34.0194,
      longitude: -118.4912,
    ...
    },
    {
      id: 2,
      name: 'Jazz Night',
      imageUrl: 'https://via.placeholder.com/200x200?text=Jazz+Night',
      county: 'Metro County',
      town: 'Groovetown',
      latitude: 40.7128,
      longitude: -74.0060,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Food+Fiesta',
      county: 'Taste County',
      town: 'Flavorburg',
      latitude: 37.7749,
      longitude: -122.4194,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Rock+Concert',
      county: 'Sound County',
      town: 'AmpCity',
      latitude: 51.5074,
      longitude: -0.1278,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/200x200?text=Movie+Night',
