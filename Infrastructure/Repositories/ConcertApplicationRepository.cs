...
public class ConcertApplicationRepository : Repository<ConcertApplication>, IConcertApplicationRepository
{
    ...
    public async Task<IEnumerable<ConcertApplication>> GetByOpportunityIdAsync(int id)
    {
    ...
    public async Task<IEnumerable<ConcertApplication>> GetPendingByArtistIdAsync(int artistId)
    {
        var query = context.ConcertApplications
    ...
    public async new Task<ConcertApplication?> GetByIdAsync(int id)
    {
        var query = context.ConcertApplications
            .Where(ca => ca.Id == id)
            .Include(ca => ca.Artist)
    ...
    public async Task<IEnumerable<ConcertApplication>> GetRecentDeniedByArtistIdAsync(int artistId)
    {
        var query = context.ConcertApplications
            .Include(a => a.Opportunity)
                .ThenInclude(o => o.Venue)
