...
internal class HeldStateMachine : IConcertStateMachine
{
    private static readonly IReadOnlyDictionary<Type, (ConcertStage From, ConcertStage To)> Transitions
        = new Dictionary<Type, (ConcertStage, ConcertStage)>
        {
            ...
            [typeof(ISimpleAcceptStep)]   = (ConcertStage.CheckedOut, ConcertStage.Accepted),
    ...
    public HeldStateMachine(IConcertLifecycleRepository repository)
    {
