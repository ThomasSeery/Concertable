...
public class StripeCliFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        process = new Process
        {
            ...
            {
                FileName = "docker",
                Arguments = $"run --rm --label=concertable-e2e=1 stripe/stripe-cli listen --skip-verify --api-key {apiKey} --forward-to {forwardUrl.Replace("localhost", "host.docker.internal")}/api/Webhook",
