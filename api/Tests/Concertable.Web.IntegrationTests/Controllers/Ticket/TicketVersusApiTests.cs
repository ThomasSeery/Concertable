...
public class TicketVersusApiTests : IAsyncLifetime
{
    ...
    public async Task Purchase_ShouldCreateTicketAndReduceAvailabilityAfterWebhook()
    {
        ...
        var request = BuildPurchaseRequest(TestConstants.PostedVersus.ConcertId);
        ...
        var concert = await client.GetAsync<ConcertDetailsResponse>($"/api/Concert/{TestConstants.PostedVersus.ConcertId}");
