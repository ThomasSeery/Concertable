...
public class ApplicationFlatFeeApiTests : IAsyncLifetime
{
    ...
    public async Task Accept_ShouldReturn400_WhenAlreadyAccepted()
    {
        ...
        // Act
        var firstResponse = await client.PostAsync($"/api/Application/accept/{fixture.SeedData.FlatFeeApp.Id}", (object?)null);
        await firstResponse.ShouldBe(HttpStatusCode.OK);
        await fixture.StripeClient.SendWebhookAsync();
        var response = await client.PostAsync($"/api/Application/accept/{fixture.SeedData.FlatFeeApp.Id}", (object?)null);
    ...
    public async Task Accept_ShouldConfirmBookingAndCreateDraftConcertAndNotifyArtist()
    {
        ...
        // Act
        var acceptResponse = await client.PostAsync($"/api/Application/accept/{fixture.SeedData.FlatFeeApp.Id}", (object?)null);
    ...
    public async Task Accept_ShouldNotCreateDraft_WhenPaymentFails()
    {
        ...
        // Act
        await client.PostAsync($"/api/Application/accept/{fixture.SeedData.FlatFeeApp.Id}", (object?)null);
