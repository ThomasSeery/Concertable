...
public class TicketVersusApiTests : IAsyncLifetime
{
    ...
    public async Task Purchase_ShouldCreateTicketAndReduceAvailabilityAfterWebhook()
    {
        ...
        var request = BuildPurchaseRequest(fixture.SeedData.PostedVersusApp.Concert!.Id);
        ...
        var concert = await client.GetAsync<ConcertDetailsResponse>($"/api/Concert/{fixture.SeedData.PostedVersusApp.Concert!.Id}");
