...
public record TestUser(Guid Id, string Email, Role Role, string? StripeAccountId = null);
...
public static class E2ETestConstants
{
    ...
    public static readonly TestUser ArtistManager1 = new(Guid.Parse("cccccccc-0000-0000-0000-000000000001"), "artistmanager1@test.com", Role.ArtistManager, "acct_1TJiMePysoXmht10");
    public static readonly TestUser VenueManager1 = new(Guid.Parse("dddddddd-0000-0000-0000-000000000001"), "venuemanager1@test.com", Role.VenueManager, "acct_1TJiMjLxk4aCq1Ui");
